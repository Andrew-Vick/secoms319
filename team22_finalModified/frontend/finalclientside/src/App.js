        ...
        <section id="Authors">
          <div className="container">
            ...
            <p id="Author-Info">
              ...
              javascript and JSON to create and design dynamic websites. I hope
              you have enjoyed our tech related webstore. It was our first take
...
function CatalogManager() {
  ...
  function loadItems(myItems) {
    ...
    for (var i = 0; i < myItems.length; i++) {
      ...
      let rating = myItems[i].rating;
      let div = document.createElement("div");
      div.innerHTML = `
                <h5>${id} - ${title} - $${price} - ${rating}</h5>
